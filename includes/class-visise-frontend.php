...
class VISISE_Frontend {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_visise_solve_challenge', array( 'VisitorSentinel\Security\ChallengeManager', 'ajaxSolve' ) );
		add_action( 'wp_ajax_nopriv_visise_solve_challenge', array( 'VisitorSentinel\Security\ChallengeManager', 'ajaxSolve' ) );
	}
